...
/* Use netconn API for protocol framing task, disable sockets layer */
#define LWIP_NETCONN 1
#define LWIP_SOCKET 0
/*----- Value in opt.h for TCPIP_THREAD_STACKSIZE: 0 -----*/
#define TCPIP_THREAD_STACKSIZE 1024
/* Keep lwIP core above application normal-priority workers to reduce TCP jitter. */
...
/*-----------------------------------------------------------------------------*/
/* USER CODE BEGIN 1 */
/* Keep runtime API profile stable across CubeMX regenerations. */
#undef LWIP_DHCP
#define LWIP_DHCP 0
#undef LWIP_NETCONN
#define LWIP_NETCONN 1
